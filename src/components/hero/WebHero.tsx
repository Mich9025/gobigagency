    ...
    <section ref={containerRef}>
      <div className="inner-container large">
        <div className="relative pt-[50px] 2xl:pt-[100px] pb-[55px] lg:pb-[85px] xl:pb-[115px] me-0 2xl:me-[-140px] md:pe-[190px] 2xl:pe-[240px] z-[1]">
          ...
          <div
            className="has_word_anim absolute hidden lg:block border-s border-border end-0 top-0 w-[180px] h-full text-base leading-[1.8] ps-[30px] pt-[150px] 2xl:pt-[200px] text-text"
            data-delay="0.75"
          >
            TRANSFORMANDO IDEAS EN EXPERIENCIAS EXTRAORDINARIAS
          </div>
            ...
            <div className="md:mt-[50px]">
              ...
              <div className="relative ms-[110px] 2xl:ms-[315px] mt-[35px] 2xl:mt-[65px]">
                ...
                <p
                  ...
                  data-delay="0.30"
                >
                  Somos GoBig Agency, una agencia de marketing digital integral que
                  crea experiencias digitales extraordinarias. Nuestro equipo desarrolla
                  estrategias innovadoras que impulsan el crecimiento de tu marca.
                </p>
                ...
                <div className="mt-[48px] has_fade_anim">
                  ...
                  >
                    <span data-text="comenzar ahora">comenzar ahora</span>
                    <ImageComponent
              ...
              <div className="mt-[41px] flex justify-end">
                <div className="inline-block ms-auto">
                  ...
                  <p className="text-lg mt-[15px] leading-tight">
                    <span className="underline text-text">Tenemos +18k</span>{" "}
                    clientes <br />
                    en todo el mundo
                  </p>
                </div>
